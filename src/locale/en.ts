export default {
  asyncAutocomplete: {
    ...
    clearIconAriaLabel: 'Deselect institution',
  ...
  confirmOnboarding: {
    chooseOption: {
      download: {
        ...
        attachments: {
          title: 'Download the addendum',
          description: 'Download the addendum and provide a digital signature in <2>p7m format</2>.',
          downloadContract: 'Download the document'
        },
        user: {
        ...
        disclaimerAttachments: 'You can have the agreement signed by the Legal Representative or proxy.',
        disclaimer: `By signing the agreement, the institution's Legal Representative expressly and specifically accepts the individual clauses indicated in the paragraph "Clauses pursuant to articles 1341 and 1342 of the Italian Civil Code"`
      },
      upload: {
        product: {
        ...
        attachments: {
          title: 'Upload the signed addendum',
          description: 'Once the document has been digitally signed, upload it to complete the <1 />subscription.'
        },
        user: {
    ...
    upload: {
      ...
      attachments: {
        ...
        description: 'Upload the digitally signed addendum in p7m format',
        dropArea: {
          title: 'Drag the signed document here or',
          link: 'select it from your computer'
        }
      },
      continue: 'Continue',
      error: {
        title: 'Upload failed',
        description: 'The document upload was not successful. <1 />Upload only one file in <3>p7m</3> format.',
        close: 'Exit',
        retry: 'Upload again'
      }
    }
  ...
  fileUploadPreview: {
    ...
    cleanIcon: 'Delete the uploaded file'
  },
  inlineSupportLink: {
  ...
  stepVerifyOnboarding: {
    ...
    ptAlreadyOnboarded: {
      ...
      description: 'To operate on a product, ask an Administrator to <1/> add you in the Users section.',
      backAction: 'Close'
    },
    alreadyOnboarded: {
      title: 'The selected institution has already joined',
      description: 'To operate on the product, ask an Administrator to <1/>add you in the Users section.',
      addNewAdmin: 'Are current Administrators no longer available and do you need <1 />to manage products? <3>Add a new Administrator</3>',
  ...
  onboardingStep1: {
    ...
    onboarding: {
      ...
      bodyDescription: 'Enter one of the required data and search the Public Administration <1/> Index (IPA) for the institution for which you want to request membership to <3/><4>{{productTitle}}</4>.',
      ...
      selectedInstitution: 'Continue with membership to <1>{{productName}}</1> for the selected institution',
      gpsDescription: "Can't find your institution in the IPA?<1 /><2>Manually enter your institution's data.</2>",
      saSubTitle: 'If you are among the private e-procurement platform operators and have <1/> already obtained <3> certification from AgID </3>, enter one of the required <1/> data and search for the institution for which you want to request membership to <1/> <5>{{productName}}.</5>',
  ...
  stepUploadAggregates: {
    ...
    subTitle: 'Download the example file, fill it in following the instructions and upload the document to add/declare the institutions to be aggregated.',
    findOutMore: 'Questions? Consult the manual',
    errors: {
      onCsv: {
        title: 'The file contains one or more errors',
        description: '<1>Download the report</1> to verify the information and upload the file again.'
      },
      invalidFormat: {
  ...
  stepAddManager: {
    ...
    changedManager: {
      ...
      message: 'The Legal Representative data entered is different from that indicated <1 />previously. Do you want to continue?'
    },
    formControl: {
  ...
  stepAddDelegates: {
    ...
    removeUser: 'Remove additional Administrator'
  },
  stepAddApplicantEmail: {
    title: 'Enter your email',
    description: 'Enter your email to receive a confirmation when your request has been successfully processed',
    applicantName: 'Name',
  ...
  additionalGpuDataPage: {
    ...
    firstBlock: {
      ...
      question: {
        ...
        gpuRequestAccessFor: 'For which public utility and/or general interest services does the institution request access?',
    ...
    secondBlock: {
      title: 'The legal representative of the Requesting Institution declares and represents irrevocably:',
      boxes: {
        first: 'to have the power to act in the name and on behalf of the Requesting Institution;',
        second: 'that the Institution, through its legal representative, the legal representative and its Directors are in possession of all the authorizations required by law for carrying out the activities subject to the request and underlying it;',
        third: 'that this legal representative and the directors of the Requesting Institution are not in one of the circumstances indicated in articles 94 and 95 of Legislative Decree no. 36/2023;',
        fourth: 'that no proceedings are pending against the same and the directors of the Requesting Institution for the application of one of the prevention measures referred to in art. 6 of Legislative Decree 159/2011 and that none of the impeditive causes provided for by art. 67 of Legislative Decree 159/2011 exist;',
        fifth: 'that the Requesting Institution is not the recipient of judicial measures, nor involved in pending proceedings that involve the application of administrative sanctions referred to in Legislative Decree of 8 June 2001, no. 231.'
      },
      legalBlockFooterInfo: 'The declarations in this document are issued pursuant to art. 46 of Presidential Decree 28.12.2000 no. 445. In case of false declarations, applicable sanctions, including criminal ones, apply, including the cases provided for and punished under Presidential Decree 28.12.2000 no. 445.'
    }
  },
  additionalDataPage: {
    title: 'Enter additional details',
    subTitle: 'Choose the option that describes your institution. If none is appropriate, select "Other" and <1 /> enter more details.',
    formQuestions: {
      textFields: {
        labels: {
          note: 'Notes',
      ...
      estabilishedRegulatoryProvision: 'The institution is a company established by law by a regulatory provision',
      belongsRegulatedMarket: 'The institution belongs to a regulated market (e.g. energy, gas, water, <1 />transport, postal services, etc...)',
    ...
    fields: {
      ...
      email: {
        ...
        errors: {
          ...
          invalidPec: 'PEC address not accepted. Enter the institutional email address used for the institution',
  ...
  completeRegistration: {
    ...
    request: {
      notFound: {
        ...
        description: 'At the moment it is not possible to proceed. Try again in a few <1 />minutes, or contact support',
    ...
    outcomeContent: {
      success: {
        ...
        attachments: {
          ...
          description: 'You have successfully subscribed to the new DORA addendum.',
          link: 'Go to the documents section'
        },
        backHome: 'Back to home'
      },
      error: {
    ...
    errors: {
      INVALID_DOCUMENT: {
        ...
        product: {
          message: 'The uploaded document does not correspond to the Membership Deed. Verify that it is correct and upload it again.'
        },
        user: {
          message: 'The uploaded document does not correspond to the form you received via email. Verify that it is correct and upload it again.'
        }
      },
      INVALID_SIGN: {
        title: 'Check the document',
        product: {
          message: 'The Digital Signature cannot be attributed to the Legal Representative indicated during membership. Verify the correspondence and upload the document again.'
        },
        user: {
          message: 'The Digital Signature cannot be attributed to the Legal Representative indicated during the request. Verify the correspondence and upload the document again.'
        }
      },
      ALREADY_ONBOARDED: {
        title: 'The selected institution has already joined',
        message: 'To operate on the product, ask an Administrator to <1 />add you in the Users section.'
      },
      GENERIC: {
        title: 'Upload failed',
        message: 'The document upload was not successful. Go back and upload it again.'
      },
      INVALID_SIGN_FORMAT: {
        title: 'Upload failed',
        message: 'The document upload was not successful. <1 />Upload only one file in <3>p7m</3> format.'
      }
    }
  },
  noProductPage: {
  ...
  onboarding: {
    ...
    phaseOutError: {
      title: 'Something went wrong',
      description: 'You cannot join the selected product as it will soon <1 /> no longer be available.',
  ...
  onboardingSubProduct: {
    alreadyOnboardedError: {
      ...
      message: 'The institution you selected has already subscribed to the <1 /><strong>Premium</strong> offer.',
      closeButton: 'Close'
    },
    subProductStepSelectPricingPlan: {
      ...
      carnetPlan: {
        ...
        showMore: 'Learn more',
        showLess: 'Show less',
        description: 'Once the carnet is selected it cannot be changed due to contract subscription.',
      ...
      consumptionPlan: {
        ...
        showMore: 'Learn more',
        showLess: 'Show less',
        description: 'By activating the consumption plan, it will no longer be possible to activate the carnet plan.',
    ...
    subProductStepUserUnrelated: {
      ...
      description: 'Your institution has not joined <strong>{{selectedProduct}}</strong>, or you do not have a role to <3/>manage the product. <5/> Ask an Administrator to <1/>add you in the <7/>Users section, or request membership to <strong>{{selectedProduct}}</strong> for your institution.',
      backHomeLabelBtn: 'Back to home',
      goToBtnLabel: 'Go to membership'
    },
    selectUserPartyStep: {
      title: 'Select your institution',
      subTitle: 'Select the institution for which you are requesting the subscription <1 />to the offer <3>{{productName}}</3>',
      searchLabel: 'Search institution',
      notFoundResults: 'No result',
      IPAsubTitle: 'Select from the Public Administration Index (IPA) the institution <1/> for which you want to request membership to {{baseProduct}} Premium',
      helperLink: "Can't find your institution? <1>Find out why</1>",
      confirmButton: 'Continue'
    },
    noPartyStep: {
      title: 'None of your institutions can <1/> join',
      subTitle: "If you don't see any institutions available in the list, the institution searched for might <1/> have already joined <3>{{productName}}</3>",
    ...
    genericError: {
      title: 'Something went wrong',
      subTitle: 'Due to a system error it is not possible to complete<0 /> the procedure. Please try again later.',
      homeButton: 'Back to home'
    },
    successfulAdhesion: {
      title: 'The membership request has been <1/>successfully sent',
      message: "You will receive a PEC at the institution's institutional address.<1 />Inside you will find the instructions to complete the <3 /> subscription to the offer <strong>{{title}}</strong>.",
      closeButton: 'Close'
    },
    billingData: {
  ...
  invalidPricingPlan: {
    title: 'Something went wrong',
    description: 'We cannot find the page you are looking for. <1 />Make sure the address is correct or go back to home.',
  ...
  stepInstitutionType: {
    ...
    institutionTypes: {
      ...
      pt: {
        ...
        description: 'Pursuant to IO - Paragraph 6.1.3 of the "Guidelines on the telematic access point to Public Administration services" issued by AgID pursuant to art. 64-bis of the CAD'
      },
      psp: {
    ...
    infoAlert: {
      ced: 'PagoPA S.p.A. provides the platform for managing onboarding requests. It does not participate in the Agreement and is not responsible for its execution.'
    },
    backLabel: 'Back',
    confirmLabel: 'Continue'
  },
  onboardingFormData: {
    ...
    billingDataPt: {
      ...
      subTitle: 'Enter the required information and make sure it is correct.<1 /> It will be used to register you as a Technology Partner for the<3 /> product <5>{{nameProduct}}</5>.'
    },
    pspDashboardWarning: 'To update the present data, contact the <1>Support</1> service',
    billingDataSection: {
      ...
      invalidRecipientCodeNoBilling: 'The entered code is associated with the tax code of an institution that does not have the invoicing service active',
      ...
      vatNumberVerificationErrorDescription: 'It was not possible to verify the VAT number at this time. Please try again later.',
      ...
      sdiCodePaAooUoDescription: 'It is the univocal code necessary to receive electronic invoices. It can be from your institution or its reference Organizational Unit.',
      ...
      assistanceContact: {
        ...
        supportEmailDescriprion: 'It is the contact that citizens see to request assistance from the institution'
      }
    },
    taxonomySection: {
      ...
      localLabel: 'Local',
      infoLabel: 'Select the territory in which your institution operates. If local, you can choose one or more areas of competence. If the institution has already joined other PagoPA products, you will find the area already set.',
      localSection: {
      ...
      modal: {
        ...
        modifyModal: {
          ...
          description: 'The change will be applied to all PagoPA products to which the institution has already joined. Do you want to continue?',
          confirmButton: 'Continue',
          backButton: 'Back'
        }
      }
  ...
  rejectRegistration: {
    outcomeContent: {
      success: {
        ...
        description: 'On the Reserved Area home you can see the available<1 />products and request membership for your institution.',
        backActionLabel: 'Back to home'
      },
      error: {
        title: 'Something went wrong.',
        description: 'Due to a system error, the procedure cannot be completed. <1 /> Please try again later.',
        backActionLabel: 'Back to home'
      },
      verify: {
        loadingText: 'We are verifying your data'
