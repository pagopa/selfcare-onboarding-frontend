export default {
  ...
  stepBillingData: {
    ...
    backLabel: 'Indietro',
    confirmLabel: 'Continua',
    businessRegisterNumber: 'n. Iscrizione al Registro delle Imprese',
    invalidbusinessRegisterNumber: 'n. Iscrizione al Registro delle Imprese non valido',
    registerType: 'Iscrizione all’Albo',
