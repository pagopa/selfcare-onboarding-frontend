...
export default function CarnetPlanCard({ discount, forward, showHeader }: Prop) {
          ...
          <CardContent>
            <Box display={'flex'} justifyContent="space-between" alignItems={'center'}>
              <Box>
                ...
                >
                  {t('onBoardingSubProduct.subProductStepSelectPricingPlan.carnetPlan.caption')}
                </Typography>
              </Box>
              {discount && (
                <Box
            ...
            <Box>
              <Typography variant="h6" mt={3}>
                {t('onBoardingSubProduct.subProductStepSelectPricingPlan.carnetPlan.title')}
              </Typography>
            </Box>
            <Box>
              <Typography
              ...
              >
                <Trans i18nKey="onBoardingSubProduct.subProductStepSelectPricingPlan.carnetPlan.infoLabel">
                  ...
                  <span style={fontMediumBlueRegular}>165€</span>
            ...
            <CardContent sx={{ height: '100%' }}>
              <RadioGroup name="radio-buttons-group">
                ...
                <Box>
                  ...
                  >
                    {t(
                      'onBoardingSubProduct.subProductStepSelectPricingPlan.carnetPlan.description'
                    )}
                  </Typography>
                </Box>
