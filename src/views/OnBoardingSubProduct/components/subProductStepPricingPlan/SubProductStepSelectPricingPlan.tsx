...
export default function SubProductStepSelectPricingPlan({ forward, product, subProduct }: Props) {
  ...
  useEffect(() => {
    if (subProduct && subProduct.id === 'prod-io-premium') {
  ...
  return (
    <>
      {errorPageVisible && isAlertVisible ? (
        <EndingPage
          minHeight="52vh"
                ...
                <Grid item xs={7}>
                  <Typography fontSize={'fontSize'} color="white" textAlign={'center'}>
                    <Trans i18nKey="onBoardingSubProduct.subProductStepSelectPricingPlan.infoSectionLabel">
                      Se il tuo ente ha già aderito ad app IO, scegli qual è il piano che più
                      soddisfa le sue esigenze. <br /> Il piano a carnet è attivabile una sola
                      volta. Una volta terminato il numero di messaggi del piano a <br /> carnet, si
                      attiverà automaticamente il piano a consumo.
                    </Trans>
                  </Typography>
                </Grid>
              </Grid>
              <Grid container item justifyContent={'center'}>
                <Box mr={3} sx={{ borderRadius: '16px' }}>
                  ...
                  <HeaderPlanCard
                    ...
                    title={t(
                      'onBoardingSubProduct.subProductStepSelectPricingPlan.carnetPlan.title'
                    )}
