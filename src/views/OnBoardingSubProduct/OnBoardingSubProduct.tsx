...
function OnBoardingSubProduct() {
  ...
  const forwardWithInstitution = (party: Party, isUserParty: boolean) => {
    ...
    setBillingData({
      ...
      vatNumber: '',
      recipientCode: origin === 'IPA' ? party.institutionId : '', // TODO to verify if use origin or institutionType
    });
    ...
    },
    {
      ...
      Component: () =>
        SubProductStepSelectUserParty({
          parties,
          forward: (party: Party, institutionId?: string) => {
            if (institutionId) {
    ...
    },
    {
      ...
      Component: () =>
        StepSearchParty({
          ...
          product: subProduct,
          forward: (party: Party, _: any) => forwardWithInstitution(party, false),
          back,
        }),
    },
    {
