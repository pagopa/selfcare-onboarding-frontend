        ...
        >
            ...
            <DialogActions>
                <Grid container direction={"column"} sx={{pl:3,pr:3}}>
                    {showConfirm &&
                    <Button color="primary" variant="contained" onClick={handleConfirm ? handleConfirm : handleClose}>
                        {confirmLabel ? confirmLabel : "Torna alla pagina di caricamento"}
                    </Button>
                    }
                    <Button sx={{mt: 2}} color="primary" variant="outlined" onClick={handleClose}>
